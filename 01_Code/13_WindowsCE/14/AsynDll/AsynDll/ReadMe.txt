========================================================================
MICROSOFT 基础类库：AsynDll 项目概述
========================================================================


应用程序向导已为您创建了此 AsynDll DLL。此 DLL 不仅
演示了 Microsoft 基础类的基本使用方法，还可
作为您编写 DLL 的起点。

此文件概述了组成 AsynDll DLL 的每个文件
的内容。
...
StdAfx.h，StdAfx.cpp
这些文件用于生成名为 AsynDll.pch 的预编译头 (PCH) 文件
