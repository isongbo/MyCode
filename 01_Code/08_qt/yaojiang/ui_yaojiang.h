...
**
** Created: Fri Feb 27 22:40:57 2015
...
public:
    ...
    void setupUi(QDialog *YaoJiang)
    {
        ...
        label->setGeometry(QRect(100, 13, 81, 21));
        QFont font;
        font.setPointSize(15);
        label->setFont(font);
        pname = new QLabel(YaoJiang);
        pname->setObjectName(QString::fromUtf8("pname"));
        pname->setGeometry(QRect(190, 8, 101, 29));
        QPalette palette;
        ...
        bstart->setGeometry(QRect(70, 540, 85, 27));
        bstop = new QPushButton(YaoJiang);
        bstop->setObjectName(QString::fromUtf8("bstop"));
        bstop->setGeometry(QRect(240, 540, 85, 27));
    ...
    void retranslateUi(QDialog *YaoJiang)
    {
        ...
        label->setText(QApplication::translate("YaoJiang", "\344\270\255\345\245\226\344\272\272\357\274\232", 0, QApplication::UnicodeUTF8));
