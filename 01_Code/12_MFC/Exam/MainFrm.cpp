...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext) 
{
	...
	m_wndSplit2.CreateView(0,1,RUNTIME_CLASS(CMyListView),
		CSize(200,200),pContext);
	m_wndSplit.SetRowInfo(0,320,1);
	m_wndSplit2.SetColumnInfo(0,320,1);
	//将右视图和底视图的地址保存在左视图中
  CMyFormView* pForm=(CMyFormView*)m_wndSplit2.GetPane(0,0);
  CMyListView* pList=(CMyListView*)m_wndSplit2.GetPane(0,1);
	CEditView* pEdit=(CEditView*)m_wndSplit.GetPane(1,0);
  pForm->m_pEdit=pEdit;
	pForm->m_pList=pList;
