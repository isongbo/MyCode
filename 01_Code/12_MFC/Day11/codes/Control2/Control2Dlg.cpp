// Control2Dlg.cpp : implementation file
//
...
CControl2Dlg::CControl2Dlg(CWnd* pParent /*=NULL*/)
	: CDialog(CControl2Dlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CControl2Dlg)
...
BEGIN_MESSAGE_MAP(CControl2Dlg, CDialog)
	//{{AFX_MSG_MAP(CControl2Dlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
void CControl2Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
